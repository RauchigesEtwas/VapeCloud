...
public class PacketListenerHandler {
    ...
    private final Map<Class<? extends IPacketEvent>, Collection<PacketExecutor>> bindings;
    ...
    public List<PacketExecutor> getListenersFor(Class<? extends IPacketEvent> clazz) {
    ...
    public <T extends IPacketEvent> T executeEvent(T event, int i) {
    ...
    public <T extends IPacketEvent> T executeEvent(T event) {
    ...
    public void registerListener(final PacketListener listener) {
        ...
        for (final Method method : methods) {
            ...
            if (IPacketEvent.class.isAssignableFrom(param)) {
                ...
                Class<? extends IPacketEvent> realParam = (Class<? extends IPacketEvent>) param;
    ...
    public void removeListener(PacketListener listener) {
        for (Map.Entry<Class<? extends IPacketEvent>, Collection<PacketExecutor>> ee : bindings.entrySet()) {
    ...
    public Map<Class<? extends IPacketEvent>, Collection<PacketExecutor>> getBindings() {
